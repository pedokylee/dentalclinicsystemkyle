                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                        <div class="text-center bg-blue-50 rounded-lg p-3">
                                            ...
                                            <p class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($apt->time)->format('h:i A') }}</p>
                                        </div>
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">{{ $apt->doctor->name ?? 'N/A' }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="flex space-x-2">
                                            <button class="px-3 py-1 border rounded-lg text-sm">Edit</button>
                                            <button class="px-3 py-1 border rounded-lg text-sm">Complete</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="bg-white w-full max-w-md rounded-2xl p-6 shadow-xl">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="type" placeholder="Ex. Cleaning, Filling..."
                            class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400">
